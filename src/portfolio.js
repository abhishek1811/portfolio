...
const bigProjects = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectDesc: "From POC to e2e implementation, Integrated metrics to ensure all our major services would be generating the Four Golden Signal metrics to be consumed by our data visualization tool Grafana. I served as the driving force throughout the project, executing all deliverable within a single iteration.",
      projectDetails: [
        {
    ...
    {
      image: require('./assets/images/rocklib.PNG'),
      projectName: "Servicing Microservices Framework",
